...
tell application \"iTunes\"
	set _name to the name of current track
	set _artist to the artist of current track
	set _album to the album of current track
	return _name & \", \" & _artist  & \", \" & _album & \",\"
end tell"))
    (if (interactive-p)
...
tell application \"iTunes\" to return name of every playlist as text
set AppleScript's text item delimiters to \"\"")))))
...
sexp."
  (split-string (substring str 0 -1) ", "))
