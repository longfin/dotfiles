...
\(fn COND THEN &rest ELSE)" nil (quote macro))
...
\(fn FIRST &rest BODY)" nil (quote macro))
...
\(fn FORM1 FORM2 &rest BODY)" nil (quote macro))
...
\(fn COND &rest BODY)" nil (quote macro))
...
\(fn TEST &rest BODY)" nil (quote macro))
...
\(fn &rest CONDITIONS)" nil (quote macro))
...
\(fn &rest CLAUSES)" nil (quote macro))
...
\(fn ARGS &rest BODY)" nil (quote macro))
...
\(fn EXPR &rest CLAUSES)" nil (quote macro))
...
\(fn VARLIST &rest BODY)" nil (quote macro))
...
\(fn &rest NUMBERS-OR-MARKERS)" nil (quote macro))
...
\(fn &optional NUMBER-OR-MARKER &rest NUMBERS-OR-MARKERS)" nil (quote macro))
...
\(fn DIVIDEND DIVISOR &rest DIVISORS)" nil (quote macro))
...
\(fn SYMBOL VALUE)" nil (quote macro))
...
;;;***

;;;### (autoloads nil nil ("anaphora-pkg.el") (20747 27413 232283))
